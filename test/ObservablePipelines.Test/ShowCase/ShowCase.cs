...
internal class ShowCase
{
    ...
    public void SetUp() {
        ...
        pipelineBuilder = serviceProvider.GetRequiredService<IPipelineBuilder>();

        logger = serviceProvider.GetRequiredService<ILogger<ShowCase>>();
    ...
    public async Task TestShowCase() {
        ...
        var pipeline = pipelineBuilder
            .ConfigureOptions(builder => builder.Add(new MessageFilterPipeOptions(Guid.Empty)))
